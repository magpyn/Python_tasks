# Wylosuj 6 liczb z przedziału od -20 do 20 oraz 3 liczby całkowite z przedziału od 1 do 10.
# Następnie na pierwszych trzech liczbach typu float zastosuj zaokrąglenie (kolejno round, ceil oraz floor).
